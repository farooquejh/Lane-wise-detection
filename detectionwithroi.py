...
def select_lane_rois_from_first_frame(video_path):
    global drawing_image, original_image, current_lane
...
def detect_and_count_video(video_path, output_path, lane_polygons, model_path='yolov8n.pt', process_every=5):
    ...
    while True:
        ...
        if frame_count % process_every == 0:
            ...
            # results = model.track(processed_frame, persist=True, stream=True, conf=0.25)[0]
            # for result in results:

            # yolov8n.pt -> convert -> yolov8n_openvino
